...
public class TelaListaCadastro extends javax.swing.JFrame {
    ...
    private void jB_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_EditarActionPerformed
        ...
        if (linha >= 0) {
            ...
            Object id = jTabela.getValueAt(linha, 0);
            System.out.println(id.toString());
            controle.abrirTelaCadastroParaEdicao(Integer.parseInt(id.toString()));
        }
    ...
    private void jB_RemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_RemoverActionPerformed
        ...
        if (posicao >= 0) {
            Object idSelecionado = jTabela.getValueAt(posicao, 0);
            int id = Integer.parseInt(idSelecionado.toString());
            if (controle.removerCadastro(id)) {
                DefaultTableModel model = (DefaultTableModel) jTabela.getModel();
